-----------------------------------------------------------------------------------------
-- Title: Physics and colisions
-- Name: Owen Meagher
-- Course: ICS20
--This program displays physics and colisions in a lua file
-----------------------------------------------------------------------------------------
...
-- play the background music from folder 
...
--create the ground and the ground variables
